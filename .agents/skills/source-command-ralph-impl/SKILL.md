---
name: "source-command-ralph-impl"
description: "Implement highest priority small Linear ticket with worktree setup"
---

# source-command-ralph-impl

Use this skill when the user asks to run the migrated source command `ralph_impl`.
