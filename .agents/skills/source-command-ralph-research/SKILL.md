---
name: "source-command-ralph-research"
description: "Research highest priority Linear ticket needing investigation"
---

# source-command-ralph-research

Use this skill when the user asks to run the migrated source command `ralph_research`.
...
2a. read .Codex/commands/research_codebase.md for guidance on effective codebase research
