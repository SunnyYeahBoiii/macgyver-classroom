---
name: "source-command-ralph-plan"
description: "Create implementation plan for highest priority Linear ticket ready for spec"
---

# source-command-ralph-plan

Use this skill when the user asks to run the migrated source command `ralph_plan`.
...
0.  read .Codex/commands/linear.md
...
1a. read ./Codex/commands/create_plan.md
...
1e. if the research is insufficient or has unaswered questions, create a new plan document following the instructions in ./Codex/commands/create_plan.md

think deeply

2. when the plan is complete, `humanlayer thoughts sync` and attach the doc to the ticket using the MCP tools and create a terse comment with a link to it (re-read .Codex/commands/linear.md if needed)
